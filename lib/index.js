...
import { auditText, formatReport, rulesBrief, filterReport, detectDocumentProfile, } from './rules.js';
...
export function apply(ctx, config = {}) {
    ...
    ctx.tools.register(defineTool({
        name: 'writing_rules',
        description: '返回论文写作纪律速查清单（dsh-plugin-writing-guard v0.3）：修改过程残留、主张校准、修辞模式、LLM 关联词、' +
