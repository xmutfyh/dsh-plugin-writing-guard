...
import { auditText, formatReport, rulesBrief, filterReport, detectDocumentProfile, hitFingerprint, diffAudit, serializeFingerprints, deserializeFingerprints, computeStyleProfile, computeJournalProfile, PLUGIN_VERSION, } from './rules.js';
...
export function apply(ctx, config = {}) {
    ...
    ctx.tools.register(defineTool({
        ...
        description: 'v1.4 Journal Profile：从目标期刊代表论文（.md/.tex/.txt）蒸馏"期刊写作档案"——每个章节的句长/段长分布、hedge 密度、因果力/证据力密度、第一人称/被动语态比例，以及全文引用密度。' +
