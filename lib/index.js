...
import { auditText, formatReport, rulesBrief, filterReport, detectDocumentProfile, hitFingerprint, diffAudit, serializeFingerprints, deserializeFingerprints, computeStyleProfile, PLUGIN_VERSION, } from './rules.js';
...
export function apply(ctx, config = {}) {
    ...
    ctx.tools.register(defineTool({
        ...
        description: 'v0.6 Author Style Profile：从作者历史论文（.md/.tex/.txt）统计写作风格指标（句长中位数/标准差、段长中位数、破折号/hedge/连接词密度），' +
